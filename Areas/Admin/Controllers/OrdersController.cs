            ...
            try
            {
                ...
                var orderData = _context.Orders
                    .Select(o => new
                    {
                        ...
                        PaymentMethod = o.PaymentMethod == 0 ? "Cash on delivery" : "Payment with Paypal",
                        ShippingMethod = o.ShippingMethod.Name,
                        Total = o.SubTotal + o.ShippingFee - o.Discount,
                        o.OrderStatus,
                        o.Discount,
                        o.CreatedAt,
                ...
                switch (sortColumn.ToLower())
                {
                    ...
                    case "total":
                        ...
                        break;
                    case "discount":
                        orderData = sortColumnDirection.ToLower() == "asc" ? orderData.OrderBy(o => o.Discount) : orderData.OrderByDescending(o => o.Discount);
                        break;
                    case "submited":
